    ...
    const collectData = async () => {
      try {
        ...
        const username = await new Promise((resolve) => {
          this.rl.question(chalk.cyan("Username: "), resolve);
        });
  
        // Get email
        const email = await new Promise((resolve) => {
          this.rl.question(chalk.cyan("Email: "), resolve);
        });
        ...
        const latitude = await new Promise((resolve) => {
          this.rl.question(chalk.cyan("Latitude: "), resolve);
        });
  
        // Get longitude
        const longitude = await new Promise((resolve) => {
          this.rl.question(chalk.cyan("Longitude: "), resolve);
        });
