      ...
      this.rl.question(chalk.cyan("Email: "), (email) => {
        ...
        const onData = (key) => {
          ...
          if (key === "\r" || key === "\n") {
            ...
            // 4. Ask for latitude
            this.rl.question(chalk.cyan("Latitude (e.g., 37.77): "), (latitude) => {
              // 5. Ask for longitude
              this.rl.question(chalk.cyan("Longitude (e.g., -122.41): "), (longitude) => {
                // 6. FINALLY submit all data
